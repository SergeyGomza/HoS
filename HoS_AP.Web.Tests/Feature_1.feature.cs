...
namespace HoS_AP.Web.Tests
{
    ...
    [NUnit.Framework.DescriptionAttribute("Character listing")]
    public partial class CharacterListingFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Character listing", "    As a Heroes of Storm Administrator\r\n    In order to feel control over system " +
                    "state\r\n    In want to see existing characters in list", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line 11
    testRunner.Then("I should be on “Character listing” page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
